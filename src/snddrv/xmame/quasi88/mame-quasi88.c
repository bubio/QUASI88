...
void xmame_dev_pcg_out_gate(byte data) {
  if (xmame_func->pcg_out_gate)
    (xmame_func->pcg_out_gate)(0, data);
}
void xmame_dev_pcg_out_counter0(byte data) {
  if (xmame_func->pcg_out_counter0)
    (xmame_func->pcg_out_counter0)(0, data);
}
void xmame_dev_pcg_out_counter1(byte data) {
  if (xmame_func->pcg_out_counter1)
    (xmame_func->pcg_out_counter1)(0, data);
}
void xmame_dev_pcg_out_counter2(byte data) {
  if (xmame_func->pcg_out_counter2)
    (xmame_func->pcg_out_counter2)(0, data);
}
void xmame_dev_pcg_out_control(byte data) {
  if (xmame_func->pcg_out_control)
    (xmame_func->pcg_out_control)(0, data);
}
...
char *assemble_3_strings(const char *dummy1, const char *summy2,
                         const char *s3) {
...
mame_file_error mame_fopen(const char *dummypath, char *filename,
                           UINT32 dummyflags, mame_file **file) {
  OSD_FILE *fp = NULL;
  char buf[1024] = "";
